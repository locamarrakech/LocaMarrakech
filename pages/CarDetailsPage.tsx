...
const CarDetailsPage: React.FC<CarDetailsPageProps> = ({ slug }) => {
  ...
  const carDescription = stripHtml(car.content.rendered).substring(0, 160) || 
  ...
  const validateForm = (): boolean => {
    ...
    if (!bookingData.phoneNumber.trim()) errors.phoneNumber = 'Phone number is required';
    if (!bookingData.city.trim()) errors.city = 'City is required';
              ...
              <div className="max-w-7xl mx-auto">
                ...
                <div className={`flex flex-wrap items-center ${isRTL ? 'justify-end' : 'justify-start'} gap-6`}>
                  <div className="flex items-baseline border border-white/20 px-6 py-3 bg-black text-white">
                    <span className="text-white text-4xl font-light">{car.car_price}€</span>
                    <span className={`text-gray-200 text-sm ${isRTL ? 'mr-2 ml-0' : 'ml-2 mr-0'}`}>/ {t('day')}</span>
                  </div>
            ...
            <div className="sticky top-24">
              <div className="border border-gray-200 dark:border-gray-700 p-6">
                <div className="text-center mb-6 pb-6 border-b border-gray-200 dark:border-gray-700">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400 uppercase tracking-widest">par jour</p>
                </div>
                ...
                <div className="flex gap-3 mb-4">
                  ...
                  <a
                    href={`https://wa.me/212627573069?text=${encodeURIComponent(`Bonjour, est-ce que cette voiture est disponible ?\n\n${car.title.rendered}\n${window.location.origin}/${car.slug}`)}`}
                    target="_blank"
                ...
                <div className="flex items-center justify-center text-xs text-gray-500 dark:text-gray-400 mb-4 py-2 border-y border-gray-200 dark:border-gray-700">
                  <span className="uppercase tracking-wider">Disponible 24/7</span>
                </div>
