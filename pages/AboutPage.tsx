  ...
  return (
    <div className="bg-white dark:bg-gray-900 min-h-screen">
        ...
        <div className="max-w-7xl mx-auto px-8 md:px-16 py-24 md:py-32">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-block border border-gray-300 dark:border-gray-700 px-4 py-2 mb-8">
              <span className="text-xs font-medium uppercase tracking-widest text-gray-600 dark:text-gray-400">À Propos</span>
            </div>
      ...
      <section className="border-b border-gray-200 dark:border-gray-800">
        <div className="max-w-7xl mx-auto px-8 md:px-16 py-16 md:py-24">
          <div className="text-center mb-16">
            <span className="text-xs font-medium uppercase tracking-widest text-gray-500 dark:text-gray-400">Nos Valeurs</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-1">
            {[
              {
                title: 'Excellence',
                description: 'Une sélection rigoureuse de véhicules premium pour garantir une expérience de conduite exceptionnelle.',
                icon: (
              ...
              {
                title: 'Service',
                description: 'Un accompagnement personnalisé disponible 24/7 pour répondre à tous vos besoins durant votre séjour.',
                icon: (
                  <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
              ...
              {
                title: 'Confiance',
                description: 'Des années d\'expérience au service de nos clients avec transparence et professionnalisme.',
                icon: (
                  <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      ...
      <section className="border-b border-gray-200 dark:border-gray-800">
        <div className="max-w-7xl mx-auto px-8 md:px-16 py-16 md:py-24">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              <span className="text-xs font-medium uppercase tracking-widest text-gray-500 dark:text-gray-400">Notre Histoire</span>
              ...
              <h2 className="text-3xl md:text-4xl font-light text-gray-900 dark:text-gray-100 mb-6 leading-tight">
                Location de Voiture Premium à Marrakech
              </h2>
              
              <div className="space-y-6 text-gray-600 dark:text-gray-400 leading-relaxed font-light">
                <p>
                  Depuis notre création, LocaMarrakech s'est imposé comme la référence en matière de location de voitures de luxe à Marrakech. Notre passion pour l'automobile et notre engagement envers l'excellence nous permettent d'offrir une expérience unique à chacun de nos clients.
                </p>
                <p>
                  Nous comprenons que chaque voyage est différent. C'est pourquoi nous proposons une flotte variée de véhicules premium, allant des berlines élégantes aux SUV spacieux, tous méticuleusement entretenus pour garantir votre confort et votre sécurité.
                </p>
                <p>
                  Notre équipe dédiée met tout en œuvre pour faciliter votre expérience, de la réservation à la restitution du véhicule. Nous sommes fiers de contribuer à rendre votre séjour à Marrakech inoubliable.
                </p>
              </div>
            </div>
      ...
      <section className="border-b border-gray-200 dark:border-gray-800">
        <div className="max-w-7xl mx-auto px-8 md:px-16 py-16 md:py-24">
          <div className="text-center mb-16">
            <span className="text-xs font-medium uppercase tracking-widest text-gray-500 dark:text-gray-400">Pourquoi Nous Choisir</span>
            <div className="w-12 h-px bg-gray-900 dark:bg-gray-100 mx-auto mt-4"></div>
          </div>
            ...
            {[
              {
                ...
                description: 'Une sélection exclusive de véhicules haut de gamme, régulièrement renouvelée'
              },
              {
                title: 'Prix Transparents',
                description: 'Aucun frais caché, des tarifs clairs et compétitifs'
              },
              {
                title: 'Service 24/7',
              ...
              },
              {
                ...
                description: 'Protection totale incluse dans tous nos contrats de location'
              },
              {
                title: 'Livraison Gratuite',
                description: 'Nous livrons votre véhicule où vous le souhaitez à Marrakech'
              },
              {
                title: 'Expérience Local',
                description: 'Notre connaissance approfondie de Marrakech à votre service'
              }
            ].map((feature, index) => (
              <div 
                key={index} 
        ...
        <div className="max-w-7xl mx-auto px-8 md:px-16 py-16 md:py-24">
          <div className="border border-gray-200 dark:border-gray-700 p-12 md:p-16 text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-8 max-w-2xl mx-auto font-light">
              Réservez dès maintenant votre véhicule et profitez d'une expérience de conduite exceptionnelle à Marrakech.
            </p>
            <a 
              href="/cars" 
