  ...
  return (
    <>
      <SEO
        ...
        description="Découvrez nos dernières actualités et conseils sur la location de voitures à Marrakech. Conseils pratiques, guides et informations utiles."
        url={blogUrl}
        type="website"
        ...
        <div className="max-w-7xl mx-auto px-8 md:px-16 py-24 md:py-32">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed font-light">
              Découvrez nos dernières actualités et conseils sur la location de voitures
            </p>
          </div>
        </div>
      </section>
